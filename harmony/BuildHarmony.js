...
class BuildHarmony {
    ...
    /** 初始化鸿蒙打包 */
    constructor(version, build, isDebug) {
        ...
        this.__project = path.join(DataHelper.instance.project, DataHelper.instance.getPlatformBuildPath("harmonyos-next"));
        this.__native = path.join(DataHelper.instance.project, DataHelper.instance.getPlatformNativePath("harmonyos-next"));
    ...
    modifyGameVersion() {
        ...
        appInfo.app.versionCode = this._buildCode;
        appInfo.app.versionName = this._versionCode;
    ...
    /** 修改证书配置 */
    modifyCertificateConfig(isDebug) {
        // 修改证书配置信息
    ...
    /** 鸿蒙hap只用debug证书签名 */
    async signatureHap(inFile, outFile) {
        // 如果输入文件不存在
